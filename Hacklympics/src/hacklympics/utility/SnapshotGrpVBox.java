...
public class SnapshotGrpVBox extends VBox {
    ...
    /**
     * Rearranges the layout of this Snapshot Group VBox.
     * Should be called when any SnapshotBox are moved to the other group.
     */
    ...
    /**
     * Removes the specified SnapshotBox from this group.
     * rearrange() should be called right after this operation.
     * @param snapshotBox the SnapshotBox to add.
     */
